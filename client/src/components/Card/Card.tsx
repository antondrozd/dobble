...
const Card = ({
  ...
  return (
    <div
      className={cn(
        "relative card-base shadow-[0_0_60px_rgba(255,255,255,0.4),0_0_100px_rgba(254,202,87,0.2)]",
        className
      )}
      ...
      {tokens.map((token, i) => {
        ...
        return (
          <div
            ...
            className={cn(
              "absolute top-1/2 left-1/2 w-[15%] h-[15%]",
              hint === token && "animate-flash"
            )}
          ...
          >
            <Icon
              className={cn(
                ...
                isClickable && "cursor-pointer hover:scale-110 active:scale-90"
              )}
            />
          </div>
        );
